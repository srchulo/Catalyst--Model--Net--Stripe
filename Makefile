# This Makefile is for the Catalyst::Model::Net::Stripe extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Catalyst/Model/Net/Stripe.pm]
...
MAKE = make
FULLEXT = Catalyst/Model/Net/Stripe
BASEEXT = Stripe
PARENT_NAME = Catalyst::Model::Net
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Catalyst/Helper/Model/Net/Stripe.pm \
	lib/Catalyst/Model/Net/Stripe.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Catalyst/Model/Net
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Catalyst/Model/Net
...
TO_INST_PM = lib/Catalyst/Helper/Model/Net/Stripe.pm \
	lib/Catalyst/Model/Net/Stripe.pm

PM_TO_BLIB = lib/Catalyst/Helper/Model/Net/Stripe.pm \
	blib/lib/Catalyst/Helper/Model/Net/Stripe.pm \
	lib/Catalyst/Model/Net/Stripe.pm \
...
DISTVNAME = Catalyst-Model-Net-Stripe-0.04
...
manifypods : pure_all  \
	lib/Catalyst/Helper/Model/Net/Stripe.pm \
	lib/Catalyst/Model/Net/Stripe.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Catalyst/Helper/Model/Net/Stripe.pm $(INST_MAN3DIR)/Catalyst::Helper::Model::Net::Stripe.$(MAN3EXT) \
	  lib/Catalyst/Model/Net/Stripe.pm $(INST_MAN3DIR)/Catalyst::Model::Net::Stripe.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *perl.core MYMETA.json \
	  ...
	  tmon.out 
	- $(RM_RF) \
	  Catalyst-Model-Net-Stripe-* blib 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Stripe Model for Catalyst'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Catalyst-Model-Net-Stripe' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Stripe Model for Catalyst",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Adam Hopkins <srchulo@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	$(NOECHO) $(ECHO) '   "dynamic_config" : 1,' >> META_new.json
	$(NOECHO) $(ECHO) '   "generated_by" : "ExtUtils::MakeMaker version 6.98, CPAN::Meta::Converter version 2.120921",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Catalyst-Model-Net-Stripe",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Stripe Model for Catalyst</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Catalyst/Helper/Model/Net/Stripe.pm blib/lib/Catalyst/Helper/Model/Net/Stripe.pm \
	  lib/Catalyst/Model/Net/Stripe.pm blib/lib/Catalyst/Model/Net/Stripe.pm 
